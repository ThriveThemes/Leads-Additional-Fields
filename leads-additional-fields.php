...
/**
 * Shortcode example 1 - return a field value
 *
 * Use this shortcode to return a dynamic value
 * Useage: [tve_value_shortcode]
 */
function leads_value()
{
    return 'Input field value';
}

add_shortcode('tve_value_shortcode', 'leads_value');


/**
 * Shortcode example 2 - return entire hidden input
 *
